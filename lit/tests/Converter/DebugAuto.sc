...
// CHECK-LABEL: circuit MyDesign :
class MyDesign extends Module {
  // CHECK: output io : { flip in : UInt<8>, out : UInt<8>
...
println(circt.stage.ChiselStage.emitCHIRRTL(new MyDesign, Array("--capture-debug", "true")))
